...
Once the setup is complete, you can log in with the following default superadmin account:
...
This application uses SMTP for sending invitations. By default, it is configured for **Mailtrap**. Update your credentials in the `.env` file:
